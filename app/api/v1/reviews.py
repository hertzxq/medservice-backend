...
def get_reviews(
    ...
    rating_min: float | None = Query(None, alias="ratingMin", ge=2.0, le=5.0),
    rating_min_legacy: float | None = Query(None, alias="rating_min", ge=2.0, le=5.0, include_in_schema=False),
    rating_max: float | None = Query(None, alias="ratingMax", ge=2.0, le=5.0),
    rating_max_legacy: float | None = Query(None, alias="rating_max", ge=2.0, le=5.0, include_in_schema=False),
